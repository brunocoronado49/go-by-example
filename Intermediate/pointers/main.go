...
// zeroval and zeroptr. zeroval has an int parameter, so arguments will be passed
// to it value, zeroval will get a copy of ival distinct from the one in the calling
// function
