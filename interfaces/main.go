...
// the interface. Here we implemente geometry on rects
...
// are in the named interface. Here's a generic measure function taking advantage
...
// Smetimes it's useful to know the runetime type of an interface value. One
